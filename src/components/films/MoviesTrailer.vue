...
<div class="main-page">
      <div class="movies-video">
        <div style="display: flex">
          ...
          <div class="movie-video">
            <video-component :data-poster="require('@/assets/images/films/' + getTrailer.img)" />
            <div >
              ...
              >
                ...
                <div class="mp-post">
                  <div class="mp-post-img">
                    <img :src="require('@/assets/images/films/' + episode.img)" alt="" style="width: 220px" class="mp-post shadow">
                  </div>
                </div>
                <div class="mp-post-item" @click="transitionMovie(episode.article)">
                  <div class="mp-post-img">
                    <img :src="require('@/assets/images/films/' + episode.img)" alt="" style="width: 220px">
                  </div>
                </div>
              </div>
            </div>
  ...
  <div  class="mp-episode-fragments">
        ...
        >
          <img  :src="require('@/assets/images/films/episodes/' + el.img)" alt="">
        </div>
  </div>
  <div v-if="isActiveSlide" class="mp-icon-close" @click="close">
    ...
    justify-content: center;">
              <img :src="require('@/assets/images/films/slideEpisode/' + item.img)" alt="">
          </div>
        </div>
      </ssr-carousel>
    </div>
...
export default {
  ...
  methods: {
    ...
    transitionFilm() {
      this.$router.push({name: 'moviesVideo', query: { 'card': this.getTrailer.article}})
    },
  },
  mounted() {
    this.getFilms()
