<template>
  <div class="main-page">
    <div class="movies-video">
      <div style="display: flex">
        ...
        <div class="movie-video">
          <video-component :data-poster="require('@/assets/images/sports/' + getTrailer.img)" />
          <div >
            ...
            >
              ...
              <div class="mp-post">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/sports/' + episode.img)" alt="" style="width: 220px" class="mp-post shadow">
                </div>
              </div>
              <div class="mp-post-item" @click="transitionMovie(episode.article)">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/sports/' + episode.img)" alt="" style="width: 220px">
                </div>
              </div>
            </div>
          </div>
    ...
    <div  class="mp-episode-fragments">
      ...
      >
        <img  :src="require('@/assets/images/sports/episodes/' + el.img)" alt="">
      </div>
    </div>
    ...
    justify-content: center;">
            <img :src="require('@/assets/images/sports/slideEpisode/' + item.img)" alt="">
          </div>
        </div>
      </ssr-carousel>
    </div>
...
export default {
  ...
  methods: {
    ...
    transitionMovie(article) {
      this.$router.push({name: 'sportPublicItem', query: { 'card': article }})
    },
    transitionFilm() {
      this.$router.push({name: 'sportVideo', query: { 'card': this.getTrailer.article}})
    },
  },
  mounted() {
    this.getSport()
