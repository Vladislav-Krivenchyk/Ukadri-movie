<template>
  <div class="main-page">
    <div class="movies-video">
      <div style="display: flex">
        ...
        <div class="movie-video">
          <video-component :data-poster="require('@/assets/images/cartoons/' + getTrailer.img)" />
          <div >
            ...
            >
              ...
              <div class="mp-post">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/cartoons/' + episode.img)" alt="" style="width: 220px" class="mp-post shadow">
                </div>
              </div>
              <div class="mp-post-item" @click="transitionMovie(episode.article)">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/cartoons/' + episode.img)" alt="" style="width: 220px">
                </div>
              </div>
            </div>
          </div>
    ...
    <div  class="mp-episode-fragments">
      ...
      >
        <img  :src="require('@/assets/images/cartoons/episodes/' + el.img)" alt="">
      </div>
    </div>
    ...
    justify-content: center;">
            <img :src="require('@/assets/images/cartoons/slideEpisode/' + item.img)" alt="">
          </div>
        </div>
      </ssr-carousel>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters('cartoonsStore', {
      getTrailerItem: 'getCartoonsState'
    }),
    getEpisodes() {
  ...
  methods: {
    ...
    transitionMovie(article) {
      this.$router.push({name: 'cartoonsPublicItem', query: { 'card': article }})
    },
    transitionFilm() {
      this.$router.push({name: 'cartoonsVideo', query: { 'card': this.getTrailer.article}})
    },
  },
  mounted() {
    this.getCartoons()
