...
<!--                  <img :src="require('@/assets/images/bloggers/' + episode.img)" alt="" style="width: 250px" class="mp-post shadow">-->
<!--                </div>-->
<!--              </div>-->
<!--              <div class="mp-post-item">-->
<!--                <div class="mp-post-img">-->
<!--                  <img :src="require('@/assets/images/bloggers/' + episode.img)" alt="" style="width: 250px">-->
<!--                </div>-->
<!--              </div>-->
<!--            </div>-->
<!--          </div>-->
...
export default {
  ...
  methods: {
    ...
    transitionMovie(article) {
      this.$router.push({name: 'moviesPostItem', query: { 'card': article }})
    },
    sendComment() {
      this.form = {
