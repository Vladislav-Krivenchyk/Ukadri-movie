...
<!--        <div class="post">-->
<!--          <div class="post-img">-->
<!--            <img v-if="getPostFilm.img" :src="require('@/assets/images/bloggers/' + getPostFilm.img)" class="post shadow" />-->
<!--            <img v-else :src="require('@/assets/no-poster.jpeg')" alt="" >-->
<!--          </div>-->
<!--          <div class="post-item">-->
<!--            <div class="post-img" >-->
<!--              <img v-if="getPostFilm.img" :src="require('@/assets/images/films/' + getPostFilm.img)"  />-->
<!--              <img v-else :src="require('@/assets/no-poster.jpeg')" alt="">-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
...
<!--              <img :src="require('@/assets/images/bloggers/actors/' + actor.img)" alt="" v-if="actor.img" class="mp-post shadow" />-->
<!--              <img :src="require('@/assets/no-poster.jpeg')" alt="" v-else />-->
<!--            </div>-->
<!--            <div class="mp-post-item">-->
<!--              <div class="mp-post-img">-->
<!--                <img :src="require('@/assets/images/bloggers/actors/' + actor.img)" alt="" v-if="actor.img"  />-->
<!--                <img :src="require('@/assets/no-poster.jpeg')" alt="" v-else />-->
<!--              </div>-->
<!--            </div>-->
<!--          </div>-->
...
export default {
  ...
  methods: {
    ...
    seeTheActor(article) {
      this.$router.push({name: 'bloggersActor', query:{ 'actor': article }})
    },
    transitionTrailer() {
      this.$router.push({name: 'bloggersTrailer', query: { 'card': this.getPostFilm.article}})
    },
    transitionFilm() {
      this.$router.push({name: 'bloggersVideo', query: { 'card': this.getPostFilm.article}})
    }
  },
  async mounted() {
