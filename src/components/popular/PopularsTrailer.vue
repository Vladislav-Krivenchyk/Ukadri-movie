...
<div class="main-page">
      <div class="movies-video">
        <div style="display: flex">
          ...
          <div class="movie-video">
            <video-component :data-poster="require('@/assets/images/popular/' + getTrailer.img)" />
            <div >
              ...
              >
                ...
                <div class="mp-post">
                  <div class="mp-post-img">
                    <img :src="require('@/assets/images/popular/' + episode.img)" alt="" style="width: 220px" class="mp-post shadow">
                  </div>
                </div>
                <div class="mp-post-item" @click="transitionMovie(episode.article)">
                  <div class="mp-post-img">
                    <img :src="require('@/assets/images/popular/' + episode.img)" alt="" style="width: 220px">
                  </div>
                </div>
              </div>
            </div>
  ...
  <div  class="mp-episode-fragments" v-if="getEpisodes.episodes">
        <div v-for="el in getEpisodes.episodes"
              :key="el.id"
              @click="getElementSlide(el.article)"
        >
<!--          <img  v-if="el.img" :src="require('@/assets/images/popular/episodes/' + el.img)" alt="">-->
        </div>
  </div>
...
<!--              <img :src="require('@/assets/images/popular/slideEpisode/' + item.img)" alt="">-->
          </div>
        </div>
      </ssr-carousel>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters('popularStore', {
        getTrailerItem: 'getPopularState'
    }),
    getEpisodes() {
  ...
  methods: {
    ...
    transitionFilm() {
      this.$router.push({name: 'popularsVideo', query: { 'card': this.getTrailer.article}})
    },
  },
  mounted() {
    this.getPopular()
