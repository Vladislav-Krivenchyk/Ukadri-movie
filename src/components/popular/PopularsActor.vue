  ...
  <div class="main-content">
    <div class="mp-inner">
          ...
          <div class="mp-img">
            <div class="mp-post">
              <div class="mp-post-img">
                <img :src="require('@/assets/images/popular/actors/'  + getTheActor.img)" alt="" class="mp-post shadow" v-if="getTheActor.img">
                <img :src="require('@/assets/no-poster.jpeg')" alt="" v-else>
              </div>
              <div class="mp-post-item">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/popular/actors/'  + getTheActor.img)" alt="" v-if="getTheActor.img">
                  <img :src="require('@/assets/no-poster.jpeg')" alt="" v-else>
                </div>
              </div>
            </div>
        ...
        <div class="mp-desc-actor">
            <div class="mp-post">
              <div class="mp-post-img">
                <img :src="require('@/assets/images/popular/picture/' + getTheActor.picture)" alt="" class="mp-post shadow" v-if="getTheActor.picture">
                <img :src="require('@/assets/no-poster.jpeg')" alt="" class="mp-images" v-else>
                <p>{{getTheActor.desc}}</p>
              </div>
              <div class="mp-post-item">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/popular/picture/' + getTheActor.picture)" alt="" class="mp-post-img-picture"  v-if="getTheActor.picture">
                  <img :src="require('@/assets/no-poster.jpeg')" alt="" class="mp-images" v-else>
                  <p>{{getTheActor.desc}}</p>
                </div>
              </div>
