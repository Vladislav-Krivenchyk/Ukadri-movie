<template>
  <div class="main-page" v-if="getFilm">
    <div class="movies-video">
            ...
            >
              ...
              <div class="mp-post">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/shou/' + episode.img)" alt="" style="width: 250px" class="mp-post shadow">
                </div>
              </div>
              <div class="mp-post-item">
                <div class="mp-post-img">
                  <img :src="require('@/assets/images/shou/' + episode.img)" alt="" style="width: 250px">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="mp-video">
        <video-component :data-poster="require('@/assets/images/shou/' + getFilm.img)"/>
