  ...
  <div class="main-page">
    <div class="main-content" v-if="getFilm.length">
      ...
      <div v-if="!isTiles">
              ...
              >
                <div class="post">
                  ...
                  <div class="post-img" v-if="overlayMouse === i"  :class="{'overlay-hover': overlayMouse === i }">
                    <img :src="require('@/assets/images/tv/' + item.img)" alt="" class="post shadow">
                  </div>
                  ...
                  <div class="post-item">
                    ...
                    <div class="post-img">
                      <img :src="require('@/assets/images/tv/' + item.img)" alt="" >
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="pagination" v-if="getFilm.length">
            ...
            <div class="main-inner-tiles">
              ...
              >
                <div class="post">
                  ...
                  <div class="post-img" v-if="overlayMouse === i"  :class="{'overlay-hover': overlayMouse === i }">
                    <img :src="require('@/assets/images/tv/' + item.img)" alt="" class="post shadow" style="height: 700px">
                  </div>
                  <div class="post-img" v-else>
                    <img :src="require('@/assets/images/tv/' + item.img)" alt="" class="post shadow" style="height: 700px">
                  </div>
                  <div class="post-item">
                    ...
                    <div class="post-img">
                      ...
                      <img :src="require('@/assets/images/tv/' + item.img)" alt="" style="height: 700px">
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    getItem(film) {
      this.$router.push({name: 'tvItem', query: { 'card': film }})
    },
    pageClick(page) {
