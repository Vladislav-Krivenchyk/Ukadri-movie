  ...
  <div class="main-page">
    <div class="main-content" v-if="getFilm.length">
      <div class="main-intro">
        <h3 style="color: #fff">Фильмы на сегодня</h3>
              ...
              >
                <div class="post">
                  ...
                  <div class="post-img" v-if="overlayMouse === i"  :class="{'overlay-hover': overlayMouse === i }">
                    <img :src="require('@/assets/images/serials/' + item.img)" alt="" class="post shadow">
                  </div>
                  ...
                  <div class="post-item">
                    ...
                    <div class="post-img">
                      <img :src="require('@/assets/images/serials/' + item.img)" alt="" >
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="main-inner-tiles">
              ...
              >
                <div class="post">
                  ...
                  <div class="post-img" v-if="overlayMouse === i"  :class="{'overlay-hover': overlayMouse === i }">
                    <img :src="require('@/assets/images/serials/' + item.img)" alt="" class="post shadow" style="height: 700px">
                  </div>
                  <div class="post-img" v-else>
                    <img :src="require('@/assets/images/serials/' + item.img)" alt="" class="post shadow" style="height: 700px">
                  </div>
                  <div class="post-item">
                    ...
                    <div class="post-img">
                      ...
                      <img :src="require('@/assets/images/serials/' + item.img)" alt="" style="height: 700px">
                    </div>
                  </div>
                </div>
              </div>
...
import SerialsPost from "@/components/serials/SerialsPost.vue";
export default {
  name: "SerialsPage",
  data() {
    return {
  ...
  methods: {
    ...mapActions('serialsStore', {
      getFilms: 'getSerials'
    }),
    getItem(film) {
      this.$router.push({name: 'serialsItem', query: { 'card': film }})
    },
    pageClick(page) {
