              ...
              >
                <div class="post">
                  ...
                  <div class="post-img" v-if="overlayMouse === i"  :class="{'overlay-hover': overlayMouse === i }">
                    <img :src="require('@/assets/images/sports/' + item.img)" alt="" class="post shadow">
                  </div>
                  ...
                  <div class="post-item">
                    ...
                    <div class="post-img">
                      <img :src="require('@/assets/images/sports/' + item.img)" alt="" >
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="main-inner-tiles">
              ...
              >
                <div class="post">
                  ...
                  <div class="post-img" v-if="overlayMouse === i"  :class="{'overlay-hover': overlayMouse === i }">
                    <img :src="require('@/assets/images/sports/' + item.img)" alt="" class="post shadow" style="height: 700px">
                  </div>
                  <div class="post-img" v-else>
                    <img :src="require('@/assets/images/sports/' + item.img)" alt="" class="post shadow" style="height: 700px">
                  </div>
                  <div class="post-item">
                    ...
                    <div class="post-img">
                      ...
                      <img :src="require('@/assets/images/sports/' + item.img)" alt="" style="height: 700px">
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...mapActions('sportsStore', {
      getFilms: 'getSport'
    }),
    getItem(film) {
      this.$router.push({name: 'sportItem', query: { 'card': film }})
    },
    pageClick(page) {
